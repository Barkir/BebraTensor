...
foreach(_cmake_expected_target IN ITEMS Bebra::bebra_core Bebra::bebra_tensor)
...
# Create imported target Bebra::bebra_core
add_library(Bebra::bebra_core STATIC IMPORTED)
...
if(NOT CMAKE_VERSION VERSION_LESS "3.23.0")
  target_sources(Bebra::bebra_core
    INTERFACE
      FILE_SET "HEADERS"
      TYPE "HEADERS"
...
# Create imported target Bebra::bebra_tensor
add_executable(Bebra::bebra_tensor IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/BebraTensorTargets-*.cmake")
