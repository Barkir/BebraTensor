...
BebraType OnnxDtypeToBebra(int32_t onnx_dtype) {
    switch (onnx_dtype) {
        case onnx::TensorProto::FLOAT:
            return BebraType::FLOAT;
        case onnx::TensorProto::DOUBLE:
            return BebraType::DOUBLE;
        case onnx::TensorProto::INT32:
            return BebraType::INT32;
        case onnx::TensorProto::INT64:
            return BebraType::INT64;
        case onnx::TensorProto::UINT8:
            return BebraType::UINT8;
        case onnx::TensorProto::INT8:
            return BebraType::INT8;
        case onnx::TensorProto::BOOL:
            return BebraType::BOOL;
        case onnx::TensorProto::FLOAT16:
            return BebraType::FLOAT16;
        default:
            return BebraType::UNDEF;
    }
}
