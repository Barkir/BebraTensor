...
TEST(GraphLoading1, LoadsWithoutMissingTensors) {
    const std::string model_path = get_model_path2("third_party/resnet50-v1-7.onnx");
...
TEST(GraphLoading2, LoadsWithoutMissingTensors2) {
    const std::string model_path = get_model_path2("third_party/mnist-8.onnx");
    Bebra::Core::BebraGraph graph(model_path);
...
TEST(GraphLoading4, LoadsWithoutMissingTensors4) {
    const std::string model_path = get_model_path2("tiny-onnx-mlir-checkers/models/01_arithmetic.onnx");
    Bebra::Core::BebraGraph graph(model_path);
...
TEST(GraphLoading6, LoadsWithoutMissingTensors6) {
    const std::string model_path = get_model_path2("tiny-onnx-mlir-checkers/models/02_gemm_classifier.onnx");
    Bebra::Core::BebraGraph graph(model_path);
